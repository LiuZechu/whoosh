class UrlUtil {
  ...
  static String generateEntireQueueUrl(int restaurantId, int groupId, String groupKey) {
    return 'https://whoosh-frontend-deploy.pages.dev/#' + generateQueueUrl(restaurantId, groupId, groupKey);
  }
  ...
  static String generateQrCodeUrl(int restaurantId) {
    ...
    String hostUrl = 'https%3A%2F%2Fwhoosh-frontend-deploy.pages.dev%2F%23%2FjoinQueue%3Frestaurant_id%3D${restaurantId}';
